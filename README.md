...
|---|---|---|
| [`plugins/working-contract/RULES.md`](plugins/working-contract/RULES.md) | 2,460 | The rules — 29 imperatives, no reasoning, no checks |
| [`plugins/working-contract/hooks/wc.mjs`](plugins/working-contract/hooks/wc.mjs) | 6,881 | The only code. One file on three hook events |
